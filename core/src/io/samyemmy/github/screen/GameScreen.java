...
import io.samyemmy.github.GameScreenTabBar;
import io.samyemmy.github.SoundHandler;
import io.samyemmy.github.MyGame;
import io.samyemmy.github.action.JumpAction;
import io.samyemmy.github.action.SadAction;
...
public class GameScreen implements Screen
{
    ...
    private void win()
    {
        ...
        score++;
        MyGame.getInstance().getActionQueue().add(new JumpAction());
    ...
    private void loose()
    {
        SoundHandler.getInstance().playSound("loose");
    ...
    public void quit()
    {
        float energyFactor = (score*2) + 10;
        tamagotchi.setEnergy(tamagotchi.getEnergy() - energyFactor);
        float happinessFactor = (score*2) + 10;
        ...
        Gdx.app.postRunnable(new Runnable() {
            @Override
            public void run() {
                MyGame.getInstance().setScreen(new ScoreScreen(score));
                tamagotchi.center();
            }
        });
    }
